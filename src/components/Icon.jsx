...
const PATHS = {
  ...
  utensils: <><path d="M7 3v18M4.5 3v4.5a2.5 2.5 0 005 0V3" /><path d="M16.5 3c-1.4 0-2.5 2.2-2.5 5s1.1 3.5 2.5 3.5V21" /></>,
  ...
  users: <><circle cx="9" cy="8" r="3" /><path d="M3.5 19a5.5 5.5 0 0111 0" /><path d="M16 5.5a3 3 0 010 5.4M17.5 19a5.5 5.5 0 00-3-4.9" /></>,
